...
public class SnakeModel {
    ...
    public void setDirection(Direction direction) {
        ...
        switch (direction) {
            case UP:
                if (this.direction == Direction.DOWN) out = true;
                break;
            case DOWN:
                if (this.direction == Direction.UP) out = true;
                break;
            case LEFT:
                if (this.direction == Direction.RIGHT) out = true;
                break;
            case RIGHT:
                if (this.direction == Direction.LEFT) out = true;
                break;
        }
        if (!out) {
